...
export default function CitizenReliefRequest({
  ...
  const resolvedRequestIdForUpload = useMemo(() => {
    ...
    const stored = parseInt(
      localStorage.getItem("lastReliefRequestId") || "",
      10,
    );
        ...
        <form className="lg:col-span-8 space-y-8" onSubmit={handleSubmit}>
          <div className="text-center md:text-left">
            ...
            <p className="text-[#6b7680] dark:text-gray-400 text-lg md:text-xl">
              Chúng tôi sẽ kết nối nhu cầu của bạn với các đơn vị cứu trợ và nhà
              hảo tâm gần nhất. Hãy giữ vững tinh thần.
            </p>
          </div>
                ...
                >
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-[#6b7680] text-sm">
                      Giúp chúng tôi nhận diện môi trường xung quanh (Tối đa 5
                      ảnh/video)
                    </p>
          ...
          <div className="py-10">
            ...
            <div className="mt-6 flex flex-col items-center text-center gap-3">
              ...
              <p className="text-[#6b7680] dark:text-gray-400 font-medium text-sm">
                Thông tin của bạn được ưu tiên xử lý bởi Ban Chỉ đạo Phòng chống
                Thiên tai Quốc gia.
              </p>
            </div>
          </div>
            ...
            <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 p-6 rounded-2xl shadow-sm mb-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center border-b border-red-100 dark:border-red-800 pb-3">
                  ...
                  <a
                    className="text-3xl font-black text-red-600 hover:scale-105 transition-transform"
                    href="tel:113"
                  >
                    113
                  </a>
            ...
            <div className="bg-orange-50 dark:bg-orange-900/10 border border-orange-200 dark:border-orange-900/50 p-6 rounded-2xl shadow-sm">
              ...
              <ul className="text-sm space-y-3 text-orange-800 dark:text-orange-200">
                <li className="flex gap-2">
                  ...
                  <span>
                    Ưu tiên nước uống sạch và đồ khô có thời hạn sử dụng lâu.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Luôn giữ pin điện thoại ở chế độ tiết kiệm năng lượng.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Để sẵn một túi cứu thương bao gồm các loại thuốc cơ bản.
                  </span>
                </li>
                <li className="flex gap-2">
                  <span className="text-primary font-bold">•</span>
                  <span>
                    Không tự ý di chuyển qua dòng nước lũ nếu không có hỗ trợ.
                  </span>
                </li>
              </ul>
            </div>
        ...
        <div className="max-w-[1200px] mx-auto px-6 grid md:grid-cols-4 gap-8">
          <div className="col-span-2">
            ...
            <p className="text-sm text-[#6b7680] max-w-sm">
              ...
              thống kết nối người dân với các đơn vị cứu trợ quân đội, công an
              và tình nguyện viên trên toàn quốc.
            </p>
          </div>
          <div>
