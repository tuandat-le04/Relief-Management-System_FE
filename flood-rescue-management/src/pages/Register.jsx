...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.success) {
        if (role === 'official') {
          setSuccess('Đăng ký thành công! Tài khoản của bạn đang chờ phê duyệt từ quản trị viên. Bạn sẽ nhận được thông báo khi tài khoản được kích hoạt.');
        } else {
      ...
      <div className="hidden lg:flex lg:w-5/12 relative flex-col justify-end bg-[#111617]">
        <div className="absolute inset-0 z-0">
          ...
          <div 
            ...
            style={{
              backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuAhwhAm5_DCZJfqK6nGimb2jqLJjO54vQFZpgYuxzd-HES9sehLVgoZlhVPtWFILPG6YK42Mzs8Sk4FbHYTnXxzLdeXlkwirSUCOrhU2YRkQPB74ADRDM5o8BeR5sdhYeYLK908BjrgnsAAjP7J0t6v5IxCHfzvAa3mWILnPQHnLyPpIwAiywTdmhyHEikyeE6spDgFcWBFlmIDX8og89FpPjIXDTGQOrLfBD2vNMzVCEvg9vDhl-5jYstR_k3nK0yx4Obw4zI2Xfo')"
            }}
          />
        </div>
        ...
        <div className="relative z-20 px-12 py-16 pb-24">
          ...
          <p className="text-text-secondary text-lg font-light leading-relaxed max-w-md">
            Hệ thống quản lý và điều phối cứu trợ tập trung. Kết nối nguồn lực, chia sẻ thông tin và hỗ trợ kịp thời trong các tình huống khẩn cấp.
          </p>
          ...
          <div className="mt-10 flex gap-4">
            ...
            <div className="flex flex-col justify-center">
              ...
              <span className="text-text-secondary text-xs">Tình nguyện viên đã tham gia</span>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex-1 flex flex-col justify-center items-center py-10 px-6 sm:px-12">
          <div className="w-full max-w-[520px] flex flex-col gap-8">
            ...
            <div className="space-y-2">
              <h2 className="text-3xl font-black text-white tracking-tight">Đăng Ký Tài Khoản Mới</h2>
              <p className="text-text-secondary text-base">Nhập thông tin để tham gia hệ thống cứu trợ.</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <div className="space-y-1">
                <label className="text-white text-sm font-medium leading-normal">Họ và tên</label>
                <input
                  name="fullName"
              ...
              {/* Phone */}
              <div className="space-y-1">
                <label className="text-white text-sm font-medium leading-normal">Số điện thoại</label>
                <input
                  name="phone"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-1">
                  <label className="text-white text-sm font-medium leading-normal">Mật khẩu</label>
                ...
                <div className="space-y-1">
                  <label className="text-white text-sm font-medium leading-normal">Nhập lại mật khẩu</label>
                  <div className="relative">
                    <input
              ...
              <div className="flex items-start pt-2">
                ...
                <label className="ml-3 text-sm font-medium text-text-secondary select-none cursor-pointer" htmlFor="terms">
                  Tôi đồng ý với <a className="text-primary hover:underline" href="#">Điều khoản sử dụng</a> và <a className="text-primary hover:underline" href="#">Chính sách bảo mật</a> của hệ thống.
                </label>
              </div>
